      ...
      <div class="row">
        <div class="col-sm-3" >
          <div class="well bg-info text-white">
            <h4 class="text-success">Take the attendance</h4>
            <p><a href="pri7_roll_call.php">Primary Seven</p> 
          </div>
        </div>
        <div class="col-sm-3">
          <div class="well">
            <h4 class="text-info">View Attendance</h4>
            <p><a href="PRI7_view_attendance.php">Primary Seven</p>
          </div>
        </div>
</body>
</html>
