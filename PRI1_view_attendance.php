...
<nav class="navbar navbar-inverse visible-xs">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="lanps_logo.png">
      <style >
        img{
      height: 80px;
  width: 80%;
  ...
  <div class="row content">
    ...
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="primaryone.php">Primary One</a></li>
        <li ><a href="primarytwo">Primary Two</a></li>
        <li ><a href="primarythree.php">Primary Three</a></li>
        <li><a href="primaryfour.php">Primary Four</a></li>
        <li><a href="primaryfive.php">Primary Five</a></li>
        <li><a href="primarysix.php">Primary Six</a></li>
...
<?php endif; ?>
<!-- //summary of students present and absent -->
<?php
include('dbconnect.php');
$date_filter = isset($_POST['date']) ? $_POST['date'] : null;

// SQL query to count students based on attendance status
if ($date_filter) {
    // For a specific date
    $sql_present = "SELECT COUNT(*) AS present_count FROM attendance WHERE status = 'present' AND date = '$date_filter'";
    $sql_absent = "SELECT COUNT(*) AS absent_count FROM attendance WHERE status = 'absent' AND date = '$date_filter'";
} else {
    // For all dates (overall summary)
    $sql_present = "SELECT COUNT(*) AS present_count FROM attendance WHERE status = 'present'";
    $sql_absent = "SELECT COUNT(*) AS absent_count FROM attendance WHERE status = 'absent'";
}
